...
from splice.serialization import xrange_helper
...
class CloudPickler(pickle.Pickler):
    ...
    def save_module(self, obj, pack=struct.pack):
        ...
        #self.save_reduce(__builtin__.__import__,(obj.__name__,{},{},['.']), obj=obj)
...
#hack for __builtin__.__import__ not working as desired
def subimport(name):
...
def _modules_to_main(modList):
    ...
    for modname in modList:
        if type(modname) is str:
            try:
                mod = __builtin__.__import__(modname)
